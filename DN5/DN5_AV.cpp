...
int main() {
  ...
  // Sedaj imamo A in b. Lahko napisemo paralelizirano Gauss-Seidel metodo. Najprej
...
#pragma omp parallel for
  ...
  // Izpisi najvecjo temperaturo
  double max_temperature = *std::max_element(T.begin(), T.end());
  std::cout << "Max. temperature: " << max_temperature << " degree C." << std::endl;
